...
def format_to_chatml(example):
    """
    Transforms raw instruction/response rows into standard ChatML messages.
    """
    messages = [
...
def load_and_prepare_dataset(config_path="configs/train_config.yaml"):
    """
    Loads target dataset and formats splits for Hugging Face SFTTrainer.
    """
